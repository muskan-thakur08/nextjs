        ...
        <div className="p-12 bg-gray-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="text-center">
                    <h2 className="text-base uppercase text-teal-500 tracking-wider font-semibold">featured webinars</h2>
                    <p className="mt-2 text-3xl leading-8 font-extrabold tracking-wide text-white sm:text-4xl" >Enhance Your Musical Journey</p>
                </div>
                <div className="mt-10">
